...
{
  name        : Option< AttributePropertySyn< syn::LitStr, NameMarker > >,
  namespace   : Option< AttributePropertySyn< syn::LitStr, NamespaceMarker > >,
  hint        : Option< AttributePropertySyn< syn::LitStr, HintMarker > >,
  description : Option< AttributePropertySyn< syn::LitStr, DescriptionMarker > >,
}
...
fn gen_value_match( inner_type_name : &str ) -> proc_macro2::TokenStream
{
...
fn gen_extraction( info : &ParamInfo ) -> proc_macro2::TokenStream
{
...
fn gen_arg_def( info : &ParamInfo ) -> proc_macro2::TokenStream
{
...
{
  match command_impl( attr.into(), item.into() )
  {
