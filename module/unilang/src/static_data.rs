...
mod private
{
  ...
  impl From< &'static StaticCommandDefinition > for crate::data::CommandDefinition
  {
    fn from( static_cmd : &'static StaticCommandDefinition ) -> Self
    {
      ...
      // Fix(BUG-088): Use static_cmd.auto_help_enabled instead of hardcoded false
      //
      ...
      // Fix(BUG-089): Use static_cmd.category instead of hardcoded ""
      //
      ...
      //
      // Pitfall: Same as BUG-088. Any field added to StaticCommandDefinition must be explicitly
