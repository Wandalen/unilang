...
impl QualityAssessor
{
  ...
  pub fn check_file_structure_compliance( &self, relative_path : &Path ) -> bool
  {
  ...
  pub fn check_file_naming_compliance( &self, file_path : &Path ) -> bool
  {
  ...
  fn assess_distribution_balance( &self ) -> Result< f64, Box< dyn std::error::Error > >
  {
    ...
    let max_variance = actual_ratios.iter()
      ...
      .fold( 0.0_f64, |acc, variance| acc.max( variance ) );
