...
use unilang::registry::{ StaticCommandRegistry, RegistryMode, CommandRegistryTrait, CommandRoutine, CommandRegistry };
...
// ============================================================================
// Task 093: into_routines + From<StaticCommandRegistry> routine transfer
// ============================================================================
