...
- **In Scope:** FR-REG-1..9, FR-ARG-1..8, FR-PIPE-1..4, FR-HELP-1..7, FR-REPL-1, FR-INTERACTIVE-1, FR-MOD-WASM-REPL
...
| `04_help_system.md` | `feature` spec for help system (FR-HELP-1..7) | ⏳ |
