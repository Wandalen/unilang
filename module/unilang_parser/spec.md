...
*   **Rule 5: Argument Types**
    ...
    *   **Named Arguments:** Any pair of tokens matching the `name::value` syntax is a named argument.
        *   **Syntax Validation:** Named arguments MUST use double-colon (`::`) separator. Single-colon (`:`) or other separators are syntax errors.
            *   ✅ **Valid:** `timeout::5000`, `verbose::true`, `path::/home/user`
            *   ❌ **Invalid:** `timeout:5000` (single colon - rejected with syntax error)
            *   ❌ **Invalid:** `timeout=5000` (equals sign - not recognized as named argument)
